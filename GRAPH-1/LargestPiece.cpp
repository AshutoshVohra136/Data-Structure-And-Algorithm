...
*/
// Consider the cake to be connected graph with every vertex connected
...
*/
//to its nearby 4 vertices
int dfs(vector<vector<int>> &cake, vector<vector<bool>> &visited, int
x, int y, int n) {
if (visited[x][y]) {
return 0;
}
